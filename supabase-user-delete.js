...
/* Charge les modules validés jusqu’au menu ordinateur StopFlow 0.5.3. */
(function(){
            ...
            fix.onload=()=>{
              ...
              mobile.onload=()=>{
                ...
                compact.onload=()=>{
                  ...
                  const desktop=document.createElement("script");
                  desktop.src="stopflow-053-desktop.js?v=0530";
                  desktop.async=false;
                  desktop.dataset.stopflowDesktopMenu="0.5.3";
