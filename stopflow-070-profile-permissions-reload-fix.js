...
(function(){
  ...
  const script=document.createElement("script");
  script.src="stopflow-070-compact-menu.js?v=0702";
  script.async=false;
...
/* StopFlow 0.7.0 — ordre et visibilité personnels des cartes. */
(function(){
  const load=()=>{
...
(function(){
  const load=()=>{
    ...
    const script=document.createElement("script");
    script.src="stopflow-070-temperature-refactor.js?v=0701";
    script.async=false;
